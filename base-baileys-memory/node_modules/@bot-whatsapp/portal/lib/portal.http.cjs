...
const start = (args) => {
    ...
    const banner = () => {
        ...
        console.log(cyan(`Abre el Whatsapp Business, entra a vincular dispositivos y escanea el codigo que esta dando el link de abajo.`));
        console.log(cyan(`- LINK DEL QR PARA INICIAR EL BOT (abrir con CTRL + CLIC): `), yellow(`${publicSite}:${port}`));
        console.log(cyan(`- Se ha creado un codigo QR `), yellow('qr.png'));
        console.log(``);
    };
